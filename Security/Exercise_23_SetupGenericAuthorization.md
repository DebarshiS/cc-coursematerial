...
## Prerequisite
Continue with your solution of the last exercise. If this does not work, you can checkout the branch [`origin/solution-22-Deploy-AppRouter`](https://github.wdf.sap.corp/cc-java/cc-bulletinboard-ads-spring-webmvc/tree/solution-22-Deploy-AppRouter).
...
* Find further details in regard to `xsappname` and the `$XSAPPNAME` environment variable [here](Readme.md).
...
- Since the video recording we had to make our application security setup multitenant aware. We use the `d012345trial` PaaS tenant in order to test the deployed microservice.
